      ...
      <div className="templateBody">
        <div className="sideBar">
            <Menu>
                ...
                <div id='menuName' onClick={onClickLoginBtn}>대시보드</div>
            </Menu>
            <Menu>
                <div id='menuCkImg'></div>
                <div id='menuName' onClick={onClickLoginBtn}>수입/지출내역</div>
            </Menu>
            <Menu>
                <div id='menuCkImg'></div>
                <div id='menuName' onClick={onClickLoginBtn}>라이브러리</div>
            </Menu>
            <Menu>
                <div id='menuCkImg'></div>
                <div id='menuName' onClick={onClickLoginBtn}>적금상품</div>
            </Menu>
        </div>
        {children}
      </div>
