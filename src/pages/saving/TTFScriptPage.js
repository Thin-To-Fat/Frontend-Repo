      ...
      <div className="bodyContent" id="ttfScriptContent">
        ...
        <div id="ttfScriptTextContent">
          <div id="method">
            ...
            <div id="methodContent">
              <p>STEP 3</p>
              <p>만기되어 출금용 통장이 된 TTF 상품으로 후불 결제하기</p>
            </div>
            <div id="methodContent">
              <p>STEP 4</p>
              <p>다음 달 지정 결제일에 올라간 내 신용등급 확인하기</p>
            </div>
          </div>
          <div id="script">
            <div id="scriptForm">
              ...
              <div id="content">
                신파일러를 대상으로 만기 완료 시 신용 점수를 올릴 수 있는 후불
                결제 수단이 제공되는 이벤트상품{' '}
              </div>
            </div>
            <div id="scriptForm">
