        ...
        <div className="dTop">
          ...
          <div className="dProfile">
            <div className="dInfo">
              ...
              <ul className="dPname">
                {userinfo.nickname ? (
                  <div id="userTitle">{userinfo.nickname}</div>
                ) : null}
                <div id="userpName">{userinfo.name} 님</div>
                {incomeModalCheck ? (
                  <li className="dashModalContainer">
                    ...
                    <div className="dashModal incomeModal">
                      ...
                      />
                      <button type="button" onClick={updateIncome}>
                        저장
                      </button>
                    </div>
                  </li>
                  ...
                  <li>
                    &gt; 월 예산 :{' '}
                    {String(incomeValue / 10000)?.toLocaleString('ko-KR')}
                    만원&nbsp;
                    <img
                      className="pencil"
                ...
                {budgetModalCheck ? (
                  ...
                  <li>
                    &gt; 월 목표 금액 :{' '}
                    {String(budgetValue / 10000)?.toLocaleString('ko-KR')}
                    만원&nbsp;
                    <img
                      className="pencil"
                      src={process.env.PUBLIC_URL + '/images/pencil.png'}
            ...
            <div id="dashboardProfileRight">
              <div className="dExpectPrice">
                <div className="dEPtitle">매달 예상 고정지출</div>
                <FixedPrice />
              </div>
              <div id="userPointArea">
                <div
                  className="userPointMenu"
                  onClick={() => {
                    navigate('/attend');
                  }}
                >
                  ...
                  <div>출석 체크</div>
                  <img
                    src={process.env.PUBLIC_URL + '/images/detailPointMenu.png'}
                    alt=""
                    id="detailPointMenu"
                  />
                </div>
